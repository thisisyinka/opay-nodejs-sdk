...
const sortObjectAlphabetically = (map) => {
  const keys = lodash.sortBy(lodash.keys(map), (a) => {
    return a;
  });
  const newmap = {};
  lodash.each(keys, (k) => {
...
lodash.mixin(
  (function () {
    var _isEmpty = lodash.isEmpty;
    return {
      isEmpty: function (value, defined) {
        if (defined && lodash.isObject(value)) {
          return !lodash.some(value, function (value, key) {
